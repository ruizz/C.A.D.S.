...
#define BUS_CLK_SetDivider(clkDivider)         BUS_CLK_SetDividerRegister(clkDivider, 1)
#define BUS_CLK_SetDividerValue(clkDivider)    BUS_CLK_SetDividerRegister((clkDivider) - 1, 1)
...
#define BUS_CLK_SetPhaseValue(clkPhase)        BUS_CLK_SetPhaseRegister((clkPhase) + 1)
#endif /* defined(BUS_CLK__CFG3) */
