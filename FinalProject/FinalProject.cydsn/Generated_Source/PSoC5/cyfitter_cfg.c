...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x480001ACu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_CSR3, 0x4Cu);
...
void AMux_1_Set(uint8 channel)
{
	...
	if ((channel < 4u) && ((AMux_1__armsEnabled & channelMask) == 0u))
	{
