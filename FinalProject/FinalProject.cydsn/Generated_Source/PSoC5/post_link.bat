...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\Chrispy\Documents\PSoC Creator\FinalProjectSave\FinalProject.cydsn\FinalProject.svd" rem "C:\Users\Chrispy\Documents\PSoC Creator\FinalProjectSave\FinalProject.cydsn\FinalProject.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
