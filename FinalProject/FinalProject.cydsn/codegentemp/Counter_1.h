 ...
 *************************************/
    ...
    ********************************/
    ...
    #define Counter_1_CONTROL              (* (reg8 *) Counter_1_CounterUDB_sCTRLReg_AsyncCtl_ctrlreg__CONTROL_REG )
    #define Counter_1_CONTROL_PTR          (  (reg8 *) Counter_1_CounterUDB_sCTRLReg_AsyncCtl_ctrlreg__CONTROL_REG )
