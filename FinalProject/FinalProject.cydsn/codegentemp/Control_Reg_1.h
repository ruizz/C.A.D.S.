...
/* Control Register */
#define Control_Reg_1_Control        (* (reg8 *) Control_Reg_1_Async_ctrl_reg__CONTROL_REG )
#define Control_Reg_1_Control_PTR    (  (reg8 *) Control_Reg_1_Async_ctrl_reg__CONTROL_REG )
